...
databases desired (SwissProt, Uniref90, and/or Pfam-A). The recommendation is to use the SwissProt and Pfam-A \
...
parser.add_option("--swissprot", action = "store_true", type = "string", dest = "swissprot", help = "annotate using the SwissProt database")
parser.add_option("--pfam", action = "store_true", type = "string", dest = "pfam", help = "annotate using the Pfam-A database")
parser.add_option("--uniref", action = "store_true", type = "string", dest = "uniref", help = "annotate using the UniRef90 database")
