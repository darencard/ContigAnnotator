...
def blast():
	...
	os.system(options.blast+" -max_target_seqs 1 -outfmt 11 -evalue "+options.evalue+" -db "+options.reference+ \
	...
	os.system(options.blast+" -max_target_seqs 1 -outfmt 11 -evalue "+options.evalue+" -db "+options.target+ \
